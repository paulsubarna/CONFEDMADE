...
class DataGenerator:
    ...
    def _generate_Non_IID(self):
        ...
        for task_id, labels in enumerate(labels_per_task): #counter, value
            ...
            #    for i in labels:
            #        if i == 0:
            #            x_task= x_mnist[len_mnist*task_id: (len(x_mnist)- (3-task_id-1)*len_mnist)]
            #        elif i == 1:
            #            x_task= x_emnist[len_emnist*task_id: (len(x_emnist)- (3-task_id-1)*len_emnist)]
            #        elif i == 2:
            #            x_task= x_fmnist[len_fmnist*task_id: (len(x_fmnist)- (3-task_id-1)*len_fmnist)]
            ...
            for idx,i in enumerate(labels):
                ...
                idx = task_id*self.args.num_clients + idx
                filename = '{}_{}'.format(self.did_to_dname[6], idx)
                self._save_task(x_task, x_task, i, filename, 6)
