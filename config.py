def set_config(args):
    ...
    args.output_path = '/app/src/Fedwit/output'#'/home/subarna/Pictures/LARS/FedWeIT-MADE/output'
...
def set_data_config(args):
    ...
    args.task_path = '/app/src/Fedwit/output'#'/home/subarna/Pictures/LARS/FedWeIT-MADE/output'
    args.ip_shape={
